...
@section('title', 'حذف جهاز كمبيوتر')
@section('content')
    <div class="app-content content">
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
                    <h3 class="mb-0 content-header-title d-inline-block">حذف جهاز كمبيوتر</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('dashboard.welcome') }}">الرئيسية</a></li>
                                <li class="breadcrumb-item"><a href="{{ route('dashboard.pc_devices.index') }}">اجهزة كمبيوتر</a></li>
                                <li class="breadcrumb-item active">حذف جهاز كمبيوتر</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bg-danger">
                                    <h4 class="text-white card-title">تأكيد حذف جهاز كمبيوتر</h4>
                                </div>
                                        ...
                                        <form action="{{ route('dashboard.pc_devices.destroy', $problem->id) }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                <h5 class="mb-2 text-danger">
                                                    <i class="la la-exclamation-triangle"></i> هل انت متاكد من حذف جهاز كمبيوتر ؟
                                                </h5>
                                                <label>الاسم</label>

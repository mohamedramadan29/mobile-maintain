        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
                    <h3 class="mb-0 content-header-title d-inline-block">اضافة قسم جديد</h3>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form action="{{ route('dashboard.programe_problem_categories.create') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                <label class="required">عدد الدقائق للاصلاح</label>
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <a href="{{ route('dashboard.programe_problem_categories.index') }}" class="btn btn-warning mr-1">

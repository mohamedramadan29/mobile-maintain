                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ route('dashboard.pc_devices.create') }}" class="btn btn-primary btn-sm">
                                            ...
                                            <tbody>
                                                @forelse ($problems as $problem)
                                                    <tr>
                                                        ...
                                                        <td> {{ $problem->name }} </td>
                                                        <td>
                                                            <a href="{{ route('dashboard.pc_devices.update', $problem->id) }}" class="btn btn-info btn-sm">
                                                                تعديل <i class="la la-edit"></i>
                                                            </a>
                                                            <a href="{{ route('dashboard.pc_devices.destroy', $problem->id) }}" class="btn btn-danger btn-sm">

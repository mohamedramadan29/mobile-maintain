    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h5> هل انت متاكد من حذف المصدر   </h5>

                <form action="{{ route('dashboard.piece_resource.destroy', $problem->id) }}" method="POST">
                    @csrf
                    <div>
                        <label> الاسم </label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-outline-danger"> حذف المصدر   </button>
                    </div>
                </form>
            </div>

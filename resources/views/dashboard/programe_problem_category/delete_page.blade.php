...
@section('title', 'حذف القسم')
@section('content')
    <div class="app-content content">
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
                    <h3 class="mb-0 content-header-title d-inline-block">حذف القسم</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('dashboard.welcome') }}">الرئيسية</a></li>
                                <li class="breadcrumb-item"><a href="{{ route('dashboard.programe_problem_categories.index') }}">اقسام اعطال جهاز البرمجة</a></li>
                                <li class="breadcrumb-item active">حذف القسم</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bg-danger">
                                    <h4 class="card-title text-white">تأكيد حذف القسم</h4>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('dashboard.programe_problem_categories.destroy', $problem->id) }}" method="POST">
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <a href="{{ route('dashboard.programe_problem_categories.index') }}" class="btn btn-light mr-1">
